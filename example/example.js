...
shell.on("tick", function () {
  if (shell.wasDown("mouse-left")) {
    console.log(
      [shell.mouseX / shell.width - 0.5, shell.mouseY / shell.height - 0.5],
      [
        shell.prevMouseX / shell.width - 0.5,
        shell.prevMouseY / shell.height - 0.5,
      ]
    );
    camera.rotate(
      [shell.mouseX / shell.width - 0.5, shell.mouseY / shell.height - 0.5],
  ...
  if (shell.wasDown("mouse-right")) {
    camera.pan([
      (shell.mouseX - shell.prevMouseX) / shell.width,
